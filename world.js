...
function open_door() {
    statusinfo.textContent = "You open the door.";
    return true;
}
...
var room01 = new Room([
    ...
    [ 54,00,02,00,50,55,50,02,00,02,02,00,50,55,50, ],
    [ 54,11,11,11,50,01,50,02,00,02,02,00,50,01,55, ],
    [ 54,11,11,11,55,01,01,02,02,02,02,02,01,01,50, ],
    [ 54,11,11,11,50,01,50,00,00,02,02,00,50,50,50, ],
    [ 53,53,53,53,53,53,53,00,00,02,02,00,53,53,53, ],
], [
    new Actor("门", "door", 6, 12, open_door),
...
var room02 = new Room([
    ...
    [ 00,11,11,11,00,00,02,55,01,01,01,50,53,51,51, ],
    [ 00,00,02,00,00,00,02,50,01,01,01,55,53,51,51, ],
    [ 02,02,02,02,02,02,02,01,01,01,01,50,53,51,51, ],
    [ 02,02,02,02,02,02,02,01,01,01,01,50,53,51,51, ],
    [ 00,00,02,00,00,02,00,50,01,01,01,50,53,51,51, ],
    ...
    new Actor("猪", "pig", 6, 1, null),
    new Actor("猪", "pig", 2, 12, null),
    new Actor("猪", "pig", 5, 12, null),
]);
